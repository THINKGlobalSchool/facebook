/* From: http://nicolasgallagher.com/lab/css3-social-signin-buttons */
...
.btn-auth:before {
    ...
    width: 22px;
    height: 22px;
    background: url("<?php echo elgg_get_site_url(); ?>mod/facebook/graphics/auth-icons.png") no-repeat 99px 99px;
}
